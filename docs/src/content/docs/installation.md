...
```bash
npm install reactive_component@npm:@lluzak/reactive_component@0.9.0
# or
pnpm add reactive_component@npm:@lluzak/reactive_component@0.9.0
```
...
```json
"dependencies": {
  "reactive_component": "npm:@lluzak/reactive_component@0.9.0"
}
```

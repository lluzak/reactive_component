...
```bash
npm install reactive_component@npm:@lluzak/reactive_component@0.8.2
# or
pnpm add reactive_component@npm:@lluzak/reactive_component@0.8.2
```
...
```json
"dependencies": {
  "reactive_component": "npm:@lluzak/reactive_component@0.8.2"
}
```

...
```bash
npm install reactive_component@npm:@lluzak/reactive_component@0.9.1
# or
pnpm add reactive_component@npm:@lluzak/reactive_component@0.9.1
```
...
```json
"dependencies": {
  "reactive_component": "npm:@lluzak/reactive_component@0.9.1"
}
```

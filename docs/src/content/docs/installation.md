...
```bash
npm install reactive_component@npm:@lluzak/reactive_component@0.8.5
# or
pnpm add reactive_component@npm:@lluzak/reactive_component@0.8.5
```
...
```json
"dependencies": {
  "reactive_component": "npm:@lluzak/reactive_component@0.8.5"
}
```

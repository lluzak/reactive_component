...
<CardGrid>
  ...
  <Card title="Automatic ERB-to-JS" icon="seti:javascript">
    Your existing ERB templates are compiled to JavaScript render functions at boot time, on Prism's own tree. Anything the compiler can't make reactive fails at compile time, by name — never in a browser.
  </Card>
